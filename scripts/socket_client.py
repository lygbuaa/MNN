...
def run_client():
    ...
    image1_path_json = {"image_filename": "bridge_640_360.jpg", "height": 270, "width": 480, "prompt": u"描述一下这张图片?"}
    image2_path_json = {"image_filename": "hhl_360_540.jpg", "height": 270, "width": 480, "prompt": u"描述一下这张图片?"}
    q1_prompt_json = {"prompt": u"图片中是哪个地方?"}
