...
def run_client_llm():
    ...
    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题, 写一首七言律诗,要求使用汉语.")
    s_client.send_array(msg)
    time.sleep(20.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题写一首十四行诗,要求使用英语.")
    s_client.send_array(msg)
    time.sleep(20.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题写一首诗歌,要求使用阿拉伯语.")
    s_client.send_array(msg)
    time.sleep(30.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题写一首诗歌,要求使用西班牙语.")
    s_client.send_array(msg)
    time.sleep(30.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题写一首诗歌,要求使用法语.")
    s_client.send_array(msg)
    time.sleep(30.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题写一首诗歌,要求使用葡萄牙语.")
    s_client.send_array(msg)
    time.sleep(30.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题写一首诗歌,要求使用德语.")
    s_client.send_array(msg)
    time.sleep(30.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题写一首诗歌,要求使用意大利语.")
    s_client.send_array(msg)
    time.sleep(30.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题写一首诗歌,要求使用日语.")
    s_client.send_array(msg)
    time.sleep(30.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt(prompt=u"以武汉黄鹤楼为题写一首诗歌,要求使用韩语.")
    s_client.send_array(msg)
    print("response: {}".format(str(s_client.full_resp)))
    time.sleep(60.0)
...
def run_client_mllm():
    ...
    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用汉语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用英语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用阿拉伯语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用西班牙语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用法语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用葡萄牙语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))


    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用德语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用意大利语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))


    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用日语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp, encoding='utf-8')))

    msg = make_request_prompt_with_image(image_filename="wuhan_bridge.jpg", prompt=u"用韩语描述一下这张图片?")
    s_client.send_array(msg)
    time.sleep(60.0)
    print("response: {}".format(str(s_client.full_resp)))
    time.sleep(180.0)
